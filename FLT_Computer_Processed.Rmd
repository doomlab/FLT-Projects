...
for (i in 1501:1525){  #length(wiki_to_check)
...
write.csv(wiki_to_check, "./output_data/wiki_to_check.csv", row.names = F)
```

## Wikipedia check

- since this doesn't actually catch the wiki ones and maybe the synonyms page  
